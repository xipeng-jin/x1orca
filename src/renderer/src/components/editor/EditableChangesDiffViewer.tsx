...
type EditableChangesDiffViewerProps = {
  ...
  sideBySide: boolean
  editable?: boolean
  // Why: optional so this Monaco compatibility renderer can still support
  // remote review-style line comments when a caller does not have local
  // worktree comment storage.
  worktreeId?: string
